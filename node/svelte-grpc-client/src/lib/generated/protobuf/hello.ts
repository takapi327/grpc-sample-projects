...
export const GreeterService = {
  /** Sends a greeting */
  sayHello: {
    path: "/com.example.protos.Greeter/SayHello",
    requestStream: false,
  ...
  sayHelloStream: {
    path: "/com.example.protos.Greeter/SayHelloStream",
    requestStream: true,
    responseStream: true,
    requestSerialize: (value: HelloRequest) => Buffer.from(HelloRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => HelloRequest.decode(value),
...
export interface GreeterServer extends UntypedServiceImplementation {
  ...
  sayHelloStream: handleBidiStreamingCall<HelloRequest, HelloReply>;
}
...
export interface GreeterClient extends Client {
  ...
  sayHelloStream(): ClientDuplexStream<HelloRequest, HelloReply>;
  sayHelloStream(options: Partial<CallOptions>): ClientDuplexStream<HelloRequest, HelloReply>;
  sayHelloStream(metadata: Metadata, options?: Partial<CallOptions>): ClientDuplexStream<HelloRequest, HelloReply>;
}

export const GreeterClient = makeGenericClientConstructor(GreeterService, "com.example.protos.Greeter") as unknown as {
